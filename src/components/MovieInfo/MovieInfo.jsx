...
const MovieInfo = () => {
  ...
  const { data: recommendations, isFetching: isFetchingRecommendation } = useGetRecommendationsQuery({ list: '/recommendations', movieId: id });
  // console.log(data);
      ...
      <Grid item container direction="column" lg={7}>
        ...
        <Grid item className={classes.containerSpaceAround}>
          <Box display="flex" align="center">
            ...
            <Typography gutterBottom variant="subtitile1" style={{ marginLeft: '10px' }}>
              {round(data?.vote_average, 1)} / 10
            </Typography>
          </Box>
